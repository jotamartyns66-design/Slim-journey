...
import { useAuth, useCollection, useFirestore, useDoc, useMemoFirebase, addDocumentNonBlocking, updateDocumentNonBlocking } from '@/firebase';
...
import { ExerciseTracker } from '@/components/dashboard/exercise-tracker';
import { ProgressMonitor } from '@/components/dashboard/progress-monitor';
