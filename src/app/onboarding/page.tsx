...
import { OnboardingStep1, Step1Data } from '../../components/onboarding/onboarding-step-1'; // CORREÇÃO AQUI
import { OnboardingStep2, Step2Data } from '../../components/onboarding/onboarding-step-2'; // CORREÇÃO AQUI
import { OnboardingStep3, Step3Data } from '../../components/onboarding/onboarding-step-3'; // CORREÇÃO AQUI
import { OnboardingStep4 } from '../../components/onboarding/onboarding-step-4'; // CORREÇÃO AQUI
import { Header } from '../../components/header'; // CORREÇÃO AQUI
import { createUserWithEmailAndPassword, updateProfile } from 'firebase/auth';
import { collection, doc } from 'firebase/firestore';
import { useAuth, useFirestore, addDocumentNonBlocking, setDocumentNonBlocking } from '../../firebase'; // CORREÇÃO AQUI
import { useToast } from '../../hooks/use-toast'; // CORREÇÃO AQUI
import { Loader2 } from 'lucide-react';
import { OnboardingStep5, Step5Data } from '../../components/onboarding/onboarding-step-5'; // CORREÇÃO AQUI
